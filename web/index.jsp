<%-- 
    Document   : index
    Created on : Feb 4, 2014, 11:42:44 AM
    Author     : ncummins
--%>
...
<html>
    ...
    <body style="background-color: cyan">
        ...
        <form id="calc1" name="calc1" method="POST" action="RectangleController" onsubmit="return valRectangle()">
            Length:  <input type="text" name="length" style="border-radius: 10px"><br>
            Width: &nbsp; <input type="text" name="width" style="border-radius: 10px"><br>
        ...
        <form id="calc2" name="calc2" method="POST" action="CircleController" onsubmit="return valCircle()">
            Radius: <input type="text" name="radius" style="border-radius: 10px"><br>           
            <input id="Submit" name="Submit" type="submit" value="Calculate">
        </form>
        <%
        ...
        <form id="calc3" name="calc3" method="POST" action="TriangleController" onsubmit="return valTriangle()">
            Side A:  <input type="text" name="sideA" style="border-radius: 10px"><br>
            Side B: <input type="text" name="sideB" style="border-radius: 10px"><br>
            <input id="Submit" name="Submit" type="submit" value="Calculate">
        </form>
        <%
